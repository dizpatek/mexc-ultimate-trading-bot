export const USER_GUIDE_CONTENT = `# 🧠 Matrix F4 Ultimate – NIHAI MASTER GUIDE (Birleştirilmiş Tüm Dökümanlar)
...
2. **Trading Modu:** Başlangıçta sistem TEST MODU'nda başlar.

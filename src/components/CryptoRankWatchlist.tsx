...
import { List, RefreshCw, TrendingUp, TrendingDown, Star, ChevronRight, ExternalLink } from 'lucide-react';
...
function CryptoRankWatchlistComponent({ watchlistId = '4f7effbd40d4' }: WatchlistProps) {
                    ...
                    >
                        ...
                        <div className="col-span-4 flex items-center gap-2">
                            ...
                            <div className="flex flex-col">
                                <span className="text-xs font-bold text-slate-200 truncate max-w-[80px]">{coin.name}</span>
                                <span className="text-[10px] text-slate-500">{coin.symbol}</span>
                            </div>
                        </div>

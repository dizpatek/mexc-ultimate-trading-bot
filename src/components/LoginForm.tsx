...
const LoginForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : 'AUTH_FAILURE: ACCESS DENIED';
                ...
                <div className="cyber-border p-8 lg:p-10 relative overflow-hidden backdrop-blur-2xl">
                    ...
                    <div className="flex flex-col items-center mb-8 relative text-center">
                        ...
                        <p className="text-[10px] tech-font text-cyan-500/60 mt-3 uppercase tracking-widest">
                            {isLogin ? "Secure Terminal Authorization Required" : "Initialize New Neural Uplink"}
                        </p>
                    </div>
                            ...
                            <div className="py-12 flex flex-col items-center justify-center space-y-6">
                                ...
                                <div className="w-full bg-black/40 p-4 border border-cyan-500/20 tech-font h-32 overflow-hidden flex flex-col-reverse items-start text-left">
                                    {logs.slice().reverse().map((log, idx) => (
                                        <div key={idx} className={`text-[10px] ${idx === 0 ? 'text-cyan-400' : 'text-cyan-900'} leading-relaxed`}>
                                            {log}
                                        </div>
                                    ))}
                                </div>
                            ...
                            <>
                                {!isLogin && (
                                    <div className="space-y-2">
                                        <label className="text-[10px] tech-font font-bold text-cyan-500/70 ml-1 uppercase tracking-wider block text-left">Ident_Username</label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] tech-font font-bold text-cyan-500/70 ml-1 uppercase tracking-wider block text-left">Auth_Email</label>
                                    <div className="relative group/field">
                                        <input
                                            type="email"
                                            required
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] tech-font font-bold text-cyan-500/70 ml-1 uppercase tracking-wider block text-left">Secure_Key</label>
                                    <div className="relative group/field">
                                        <input

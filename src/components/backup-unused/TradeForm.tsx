        ...
        <div className="flex flex-col h-full p-4 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between mb-4 relative z-10 shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest leading-none mb-1.5">
                            Trade Signal
                        </h3>
                        <p className="text-[10px] font-bold text-slate-600 uppercase tracking-tight">Matrix Operation Center</p>
                    </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-3 relative z-10">
                ...
                <div className="grid grid-cols-2 gap-2 p-1.5 bg-slate-950/50 border border-white/5 rounded-xl shrink-0">
                    <button
                        type="button"
                        onClick={() => setSignal('buy')}
                        className={cn(
                            "py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all",
                            signal === 'buy' 
                ...
                <div className="space-y-1 shrink-0">
                    <div className="flex items-center justify-between px-1 mb-1">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest">Symbol</label>
                ...
                <div className="grid grid-cols-2 gap-3 shrink-0">
                    <div className="space-y-1">
                        <div className="flex items-center justify-between px-1 mb-1">
                            ...
                            <button 
                                ...
                                className="text-[10px] font-black text-cyan-500 hover:text-cyan-400 uppercase tracking-tighter"
                            >
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center justify-between px-1 mb-1">
                            <label className="text-xs font-black text-slate-500 uppercase tracking-widest">USDT</label>
                            <button 
                                type="button"
                                onClick={handleMaxUsdt}
                                className="text-[10px] font-black text-amber-500 hover:text-amber-400 uppercase tracking-tighter"
                            >
                ...
                <div className="grid grid-cols-3 gap-2 shrink-0">
                    <div className="space-y-1.5">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">Risk%</label>
                        <input
                            type="number"
                            value={risk}
                            onChange={(e) => setRisk(e.target.value)}
                            className="w-full bg-slate-900/50 border border-white/5 rounded-lg px-2 py-2 text-xs font-black text-white outline-none focus:border-amber-500/50 transition-all"
                            placeholder="1.0"
                        />
                    </div>
                    <div className="space-y-1.5">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">TP %</label>
                        <input
                            type="text"
                            value={tp}
                            onChange={(e) => setTp(e.target.value)}
                            className="w-full bg-slate-900/50 border border-white/5 rounded-lg px-2 py-2 text-xs font-black text-white outline-none focus:border-emerald-500/50 transition-all"
                            placeholder="1.5,2.0"
                        />
                    </div>
                    <div className="space-y-1.5">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">SL %</label>
                        <input
                            type="text"
                            value={sl}
                            onChange={(e) => setSl(e.target.value)}
                            className="w-full bg-slate-900/50 border border-white/5 rounded-lg px-2 py-2 text-xs font-black text-white outline-none focus:border-rose-500/50 transition-all"
                            placeholder="0.8"
                        />
                    </div>
                </div>
                ...
                {message && (
                    <div className={cn(
                        "absolute bottom-20 inset-x-4 p-2.5 rounded-xl border text-[10px] font-black uppercase text-center animate-in fade-in slide-in-from-bottom-2 duration-300 z-50 shadow-2xl backdrop-blur-md",

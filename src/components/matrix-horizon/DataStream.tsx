    ...
    >
      ...
      <div className="flex flex-col gap-1.5 flex-1 relative">
        ...
        {data.map((item, idx) => (
          <div
            key={idx}
            className="group relative flex items-center justify-between p-2 rounded bg-slate-900/40 hover:bg-cyan-900/10 border border-transparent hover:border-cyan-500/20 transition-all"
          >

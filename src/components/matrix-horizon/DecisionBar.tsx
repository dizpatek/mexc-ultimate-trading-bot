    ...
    >
      ...
      <div className="flex flex-col z-10 w-full lg:w-[22%] relative">
        <div className="flex items-center gap-2 mb-0.5 justify-center lg:justify-start">
          ...
          <span className="text-[9px] uppercase font-black tracking-[0.3em] text-cyan-500/60">
            ANALİZ MODU
          </span>
        </div>
        ...
        >
          ...
          {isShort && (
            <Play
              size={20}
              fill="currentColor"
              className="rotate-180 drop-shadow-[0_0_10px_currentColor]"
            />
          )}
          {isWait && (
          ...
          {isWait && (
            <X
              size={28}
              className="text-rose-500 ml-1 drop-shadow-[0_0_15px_rgba(244,63,94,0.6)]"
            />
          )}
          {!isWait && (

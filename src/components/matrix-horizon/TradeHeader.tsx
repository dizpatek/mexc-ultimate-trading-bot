        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">
              Nöro-Motor Entegre {" // "} {tradesCount} Pozisyon {" // "} Son
              Sinyal:{" "}
        ...
        {hasTradeItems && (
          <div className="flex items-center gap-2 relative">
            <button
              onClick={(e) => {
                e.stopPropagation();
                setPendingClear(activeTab === "AKTIF" ? "active" : "passive");
              }}
              ...
              className={cn(
                ...
                clearingAction !== null || pendingClear !== null
              ...
              title={
                activeTab === "AKTIF"
                  ? "TÜM AKTİF POZİSYONLARI KAPAT VE SAT"
                  : "İŞLEM GEÇMİŞİNİ TEMİZLE"
              }
            >
              {clearingAction !== null ? (
            ...
            {pendingClear !== null && (
              <div className="absolute right-0 top-full mt-2 z-50 flex items-center gap-2 px-4 py-3 rounded-xl bg-slate-900 border border-rose-500/30 shadow-[0_0_30px_rgba(244,63,94,0.2)] animate-in fade-in slide-in-from-top-2 duration-200 whitespace-nowrap">
                <span className="text-[10px] font-black text-rose-300 uppercase tracking-wider mr-2">
                  {pendingClear === "active"
                    ? "TÜM POZİSYONLAR SATILACAK!"
                    : "GEÇMİŞ SİLİNECEK!"}
                </span>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    handleClearAll(pendingClear);
                  }}

...
export const logger = {
    info: (message: string, details?: string) => enqueueLog('INFO', message, details),
    warn: (message: string, details?: string) => enqueueLog('WARN', message, details),
    error: (message: string, details?: string) => enqueueLog('ERROR', message, details),
    success: (message: string, details?: string) => enqueueLog('SUCCESS', message, details),
    ai: (message: string, details?: string) => enqueueLog('INFO', `🤖 ${message}`, details),
    whale: (message: string, details?: string) => enqueueLog('WARN', `🐋 ${message}`, details)
};

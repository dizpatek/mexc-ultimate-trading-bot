 ...
 */
async function processAndTranslateBatch(articles: CryptoCompareArticle[]): Promise<ProcessedNewsItem[]> {
...
export async function fetchAndProcessNews(): Promise<ProcessedNewsItem[]> {
    try {
        ...
        console.log(`[NewsService] Processing ${rawNews.length} articles with concurrency limit...`);
